...
```{r fitplot1, fig.width = 10, fig.height = 10}
plot(fitobj)
```

```{r fitplot2, fig.width = 10, fig.height = 10}
...
```{r fitplot1second, fig.width = 10, fig.height = 10}
plot(fitobj2)
```

```{r fitplot2second, fig.width = 10, fig.height = 10}
