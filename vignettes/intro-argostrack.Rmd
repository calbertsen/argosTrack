...
knitr::opts_chunk$set(echo=FALSE,error=TRUE,message = FALSE,warning=TRUE,
...
```{r, fig.cap = "Plot of simulated observations per location class"}
...
The estimated parameters can easily be compared to the parameters used in the simulation
